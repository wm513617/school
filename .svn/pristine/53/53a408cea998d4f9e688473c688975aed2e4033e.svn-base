    ...
    <video-frame ref="frame" pluginType="record" :pluginCount="16" :clickInit="false" :defaultShowscreen="1" @update:state="setState" :slotHeight="56" @playEnd="finishPlay" @setShowscreen="num => $emit('screen', selectedShowscreen = num)" @activeChange="avtiveChange" @changePluginData="changePluginData" :bgColor="'#404040'" :fullScreenflag="fullScreenflag" :showBtn="false">
      <div class="playback">
        ...
        <div style="float:right">
          ...
          <!-- 剪切下载功能已实现 -->
          <div class="dp-con">
            <i class="icon iconfont icon-jianqiexiazai" :class="{'disable' : !isasyn}" @click="cutDownload" title="剪切"></i>
          ...
          <i class="icon iconfont icon-screenshot" :class="{'disable' : !isasyn}" @click="getCapture" title="截图"></i>

          <i class="icon iconfont icon-xiazai" :class="{'disable' : !isasyn}" title="下载" @click="openDownload"></i>
          ...
          <div class="dp-con" @mouseenter="showTowall=true" @mouseleave="showTowall=false">
            <i class="icon iconfont icon-tv-wall" :class="{'disable' : !isasyn}" title="快速上墙"></i>
            <div v-show="showTowall&&isasyn" class="showTowall">
              <iframe v-if="showTowall&&isasyn" style="margin-left:-100%;"></iframe>
          ...
          <div class="dp-con" @mouseenter="showmodeShow=true" @mouseleave="(hoverShowmode=selectedShowmode)&&(showmodeShow=false)">
            <i class="icon iconfont icon-display-scale" title="窗口适配"></i>
            <ul v-show="showmodeShow" class="display-scale">
          ...
          <i class="icon iconfont icon-full-screen" :class="{'disable' : !isasyn}" title="全屏" @click="overlayScreen"></i>
...
export default {
  ...
  computed: {
    ...
    btnDownloadDisable() {
      return !this.authInfo.downLoad || !this.isasyn
    },
    btnScreenshotDisable() {
      return !this.authInfo.screenshot || !this.isasyn
    },
    btnBoostDisable() {
      return !(this.isasyn)
    },
