...
export default {
  ...
  watch: {
    ...
    isShowEmergencyPanel() {
      this.isShow = true
      console.log(this.isShow, '1111111111111111111')
    },
    isShow(val) {
  ...
  computed: {
    ...
    ...mapGetters('fengMapApplyInteractive', ['isShowEmergencyPanel'])
  },
  methods: {
    ...mapActions(['emergencyAction']),
    ...mapMutations('fengMapApplyInteractive', ['CHANGE_IS_OPEN_LEFT_PANEL']),
    closeVideo() {
