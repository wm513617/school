export const download = (url, nameFormat, complete, defeated, progress, type) => {
  ...
  req.setRequestHeader('Authorization', window.sessionStorage.getItem('user.access_token') || '')
