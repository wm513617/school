  ...
  <div class="attr-video attr-panel">
    <header>
      ...
      <Icon class="btn" type="ios-videocam" :class="attrInfo.isOnline ? 'online' : 'offline'" title="视频预览"
            @click.native="attrInfo.isOnline && openPointVideo()" style="margin-right: 24px">
      </Icon>
    ...
    <section class="main">
      <ul class="info-list">
        ...
        <li v-if="attrInfo.eid.manufacturer">
          <span class="label">厂商</span>
          <span class="value" :title="attrInfo.eid.manufacturer">{{attrInfo.eid.manufacturer}}</span>
        </li>
