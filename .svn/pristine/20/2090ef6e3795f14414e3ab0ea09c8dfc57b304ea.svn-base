...
const StyleConfig = {
  ...
  alarmPointAlarmSymbol: {
    iconStyle: {
      url: '/static/mapimg/alarm/commonAlarm/alarm_common_ing.png',
      anchor: iconStyleAnchor,
      scale: iconStyleScale,
      rotation: 0,
      opacity: 1
  ...
  fireAlarmPointAlarmSymbol: {
    iconStyle: {
      url: '/static/mapimg/alarm/fireAlarm/firealarm_ing.png',
      anchor: iconStyleAnchor,
      scale: iconStyleScale,
      rotation: 0,
      opacity: 1
  ...
  alarmPointHostSymbol: {
    iconStyle: {
      url: '/static/mapimg/alarm/alarmHost/alarmhost_ing.png',
      anchor: iconStyleAnchor,
      scale: iconStyleScale,
      rotation: 0,
      opacity: 1
