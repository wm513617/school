...
export default {
  ...
  computed: {
    ...mapState({
      bottomCanvasData: ({ map2DApplyIX }) => map2DApplyIX.bottomCanvasData,
      mapStatisticOnCount: ({ map2DApplyIX }) => map2DApplyIX.mapStatisticOnCount,
      mapStatisticOffCount: ({ map2DApplyIX }) => map2DApplyIX.mapStatisticOffCount,
