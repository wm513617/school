...
// function areaManage(areaArr, style, layerConfig) {
//   let arr = []
//   for (let i = 0; i < areaArr.length; i++) {
//     let area = areaArr[i]
//     style = JSON.parse(JSON.stringify(style))
//     if (area.style) {
//       style = convertStyleToSymbol(style, area.style)
//     }
//     if (style.textStyle) {
//       style.textStyle.label = layerConfig.label + ':' + area.name
//     }
//     arr.push({
//       geom: {
...
//   style = JSON.parse(JSON.stringify(style))
//   if (attr.style) {
//     style = convertStyleToSymbol(style, attr.style)
//   }
//   if (style.textStyle) {
//     style.textStyle.label = layerConfig.label + ':' + attr.label
//   }
//   let feature = {
//     geom: {
//       type: GEOMETRYTYPE.MULTIPOLYGON,
