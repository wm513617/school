...
export default {
  ...
  methods: {
    ...mapMutations('mapAlarm', ['SAVE_NORMAL_ALARM_LIST', 'SAVE_FIRE_ALARM_LIST', 'SAVE_ALARM_HELP_LIST', 'SAVE_VIDEO_ALARM_LIST', 'SAVE_INTELLIGENT_ALARM_LIST', 'SAVE_ISMODAL_SURE_OR_CLEAN', 'CHANGE_FACE_TRAIL_STATUS', 'CHANGE_FACEALARM_TRAIL', 'REMOVE_ALARMTAB_ITEM']),
