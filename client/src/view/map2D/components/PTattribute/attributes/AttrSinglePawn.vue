<template>
  <div class="attr-video attr-panel">
    <header>
      ...
      <!-- <span class="btn iconfont icon-guaduan" style="font-size: 20px;margin: -2px 7px 0px 0px;" title="语音对讲" @click="isToTalk = true"></span> -->
...
export default {
  ...
  methods: {
    ...
    ...mapActions('map2DApplyIX', ['singleSendMssage']),
