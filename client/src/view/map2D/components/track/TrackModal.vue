<!-- 轨迹查询弹出框 -->
<template>
  <Modal v-model="showTrackModal2D" :mask-closable="false" :closable="false" :footer-hide="true" :width="560">
...
export default {
  ...
  computed: {
    ...mapState({
      showTrackModal2D: ({ mapIndex }) => mapIndex.showTrackModal2D // 是否显示轨迹查询弹出框
    })
  },
  mounted() {},
  methods: {
