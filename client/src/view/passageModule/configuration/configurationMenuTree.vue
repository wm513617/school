  ...
  <div class="org-actions-box" :class="{orgHeight: !isShowTitle}">
    ...
    <div class="box-tree" style="padding:0px;height:calc(100% - 122px)">
      <bs-scroll ref="scroller">
        ...
        <Tree-Search style="height:100%;" :treeData="treeData[0]||{}" ref="tree" :searchVal="searchVal"  @node-click='handleNode' isSearch @on-expand="$refs.scroller.update()" :activeId="activeId">
  ...
  export default {
    ...
    methods: {
      ...
      openAddModal(way) {
        ...
        // console.log(this.$refs.orgFormData)
        // debugger
