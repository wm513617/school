...
export default {
  ...
  computed: {
    ...
    activeMapCenter() {
      let center = this.$fengMap.center
      // [ 12947741.018056273460388, 4861209.993831714615226 ]
      // this.$context2D.map.getView().getCenter()
      return center
    }
  },
  watch: {},
  ...
  mounted() {
    console.log(this.$fengMap)
    this.mapConfigFrom.lon = this.activeMapCenter['x']
    this.mapConfigFrom.lat = this.activeMapCenter['y']
  }
}
</script>
<style scoped>
