    ...
    <Row class="bs-content">
      <div class="bs-left">
        <div class="sidebar">
          <a >机构资源</a>
          <div class="tree-org">
            <BStreeNewBox :iconToggle="false" :searchToggle="true" :searchType="0" :equipmentToggle="false" :resourceToggle="false" :btnGroup="true" :orgType="5" :resType="[0]" @clickData="getDevicesDataClick"></BStreeNewBox>
          </div>
        </div>
          ...
          <div class="table-header">
            ...
            <div class="table-header-actions clear">
              <div class="actions-btn">
                ...
                <Button  type="ghost" icon="trash-a" @click="resDelOpen" v-if="resTabs[resActiveTab].btnShow.modify">修改</Button>
                <Button  type="ghost" icon="arrow-move" @click="resMoveOpen" v-if="resTabs[resActiveTab].btnShow.move">移动</Button>
                <Button  type="ghost" icon="arrow-move" @click="resMoveOpen" v-if="resTabs[resActiveTab].btnShow.Obtain">获取</Button>
                <Button type="ghost" icon="refresh" @click="resTableFresh" v-if="resTabs[resActiveTab].btnShow.copy">复制到</Button>
                <Button type="ghost" icon="refresh" @click="resTableFresh" v-if="resTabs[resActiveTab].btnShow.synchronization">同步到</Button>
                <Button type="ghost" icon="refresh" @click="resTableFresh" v-if="resTabs[resActiveTab].btnShow.resfesh">刷新</Button>
                <Checkbox v-model="isShowSubecMhanismEquipment[resActiveTab]" @on-change="showChildRefresh"  v-if="resTabs[resActiveTab].btnShow.equipment">显示子机构设备</Checkbox>

              </div>
              <div class="actions-search">
                 <div v-if="resTabs[resActiveTab].btnShow.personType">
                   <label for="">人员类型</label>
                   <Select  style="width:100px;" placeholder="人员类型"  >
                ...
                <div v-if="resTabs[resActiveTab].btnShow.synchronizationStatus">
                  ...
                  <Select   style="width:100px" placeholder="同步状态"  >
...
export default {
  ...
  methods: {
    selectChannelName() {}, // 人员类型
    selectBatchStream() {}, // 人员类型
    seekResData() {}, // 搜索
    getDevicesDataClick() {},
    showChildRefresh() {},
    selectResRow() {},
