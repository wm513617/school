<template>
  <div ref="leftPanel" class="map-position-left" :style="panelStyle">
    <p class="iconfont" :class="[leftPanelShow?'icon-shrink':'icon-extend']" @click="togglePanelShow"></p>
...
<script>
import mapEditTree from './2DMapEdittree'
...
export default {
  ...
  computed: {
    ...mapGetters(['leftPanelShow']),
    panelStyle() {
      return { width: '330px' }
    }
  },
  methods: {
    ...mapActions(['setLeftPanelShow']),
    togglePanelShow() {
      let panelShow = !this.leftPanelShow
